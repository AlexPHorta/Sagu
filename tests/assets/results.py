...
test_flat_paths = {'about:applications': {}, 'about:quotes': {},
			'about:getting_started': {}, 'downloads:all_releases': {},
			'downloads:source_code': {}, 'downloads:windows': {},
			'downloads:mac_os': {}, 'downloads:other_platforms': {},
			'documentation:beginners_guide': {}, 'documentation:developers_guide': {},
			'documentation:faq': {}, 'community:mailing_lists': {},
			'community:forums': {}, 'community:conferences': {}, 'news': {}}


test_basic_paths = ['about:applications', 'about:getting_started']

content_markdown = ("<p>Markdown is a <strong>lightweight markup language</strong> "
