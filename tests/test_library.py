...
class TestLibrary:
    @pytest.fixture
    def library(self):
        return ssg.structures.Library(asset("basic_paths.toml"))

    def test_empty_library(self):
        """The library of posts."""
        library = ssg.structures.Library()
    ...
    def test_empty_library_with_path(self):
        ...
        library = ssg.structures.Library(asset("TestLibrary/paths.toml"))
    ...
    def test_library_with_path_and_posts(self, library):
        ...
        for case, attrs in cases.items():
            post = ssg.structures.Post(asset(case), website_path=library.flat_tree)
    ...
    def test_library_retrieve_post_content(self, library):
        ...
        post = ssg.structures.Post(asset("simple_ok_post.toml"), website_path=library.flat_tree)
        library.add_post(post)
